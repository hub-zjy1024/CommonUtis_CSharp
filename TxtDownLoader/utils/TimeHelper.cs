...
namespace TxtDownLoader.utils
{
    class TimeHelper
    {
        private static DateTime START_TIME = new DateTime(1970, 1, 1);
        /// <summary>
        /// 获取时间戳
        /// </summary>
        /// <returns></returns>
        ...
        {
            System.DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(START_TIME);
        ...
        {
            DateTime dtStart = TimeZone.CurrentTimeZone.ToLocalTime(START_TIME);
